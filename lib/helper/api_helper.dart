...
{List<NewsModel>news=[];
 ...
 return news;
  ...
  {List<NewsModel>news=[];
  var response =await http.get(Uri.parse('https://newsapi.org/v2/top-headlines?country=${Provider.of<CountryProv>(context).country}&category=$category&apiKey=$apiKey'));
  var body=jsonDecode(response.body);
